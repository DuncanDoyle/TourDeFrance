...
<html>
	...
	<body class="listEtappeUitslag">
		...
		%>
			...
			<display:table id="bolletjesTruiUitslagTable" name="model.uitslagmodel.etappe.witteTrui" class="listTable bolletjesTruiUitslagTable" requestURI="listEtappeUitslag.htm" sort="list" defaultsort="1">
				<display:column property="nummer" title="Rennernummer" sortable="false"/>
		 		<display:column property="voornaam" title="Renner Voornaam" sortable="false"/>
		 		<display:column property="achternaam" title="Renner Achternaam" sortable="false"/>
			</display:table>
			<h3>RodeLantaren</h3>
			<display:table id="bolletjesTruiUitslagTable" name="model.uitslagmodel.etappe.rodeLantaren" class="listTable bolletjesTruiUitslagTable" requestURI="listEtappeUitslag.htm" sort="list" defaultsort="1">
				<display:column property="nummer" title="Rennernummer" sortable="false"/>
		 		<display:column property="voornaam" title="Renner Voornaam" sortable="false"/>
		 		<display:column property="achternaam" title="Renner Achternaam" sortable="false"/>
			</display:table>
			<h3>EersteUitvaller</h3>
			<display:table id="bolletjesTruiUitslagTable" name="model.uitslagmodel.etappe.eersteUitvaller" class="listTable bolletjesTruiUitslagTable" requestURI="listEtappeUitslag.htm" sort="list" defaultsort="1">
				<display:column property="nummer" title="Rennernummer" sortable="false"/>
		 		<display:column property="voornaam" title="Renner Voornaam" sortable="false"/>
		 		<display:column property="achternaam" title="Renner Achternaam" sortable="false"/>
			</display:table>
		...
		<br/>
		<br/>
		<a href="editEtappeUitslag.htm?etappe=${model.uitslagmodel.etappe.etappenummer}"/>Etappe Details</a>
	</body>
</html>