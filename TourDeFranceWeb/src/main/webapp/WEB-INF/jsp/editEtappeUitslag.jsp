...
<html>
	...
	<body>
		Etappenummer: <c:out value="${etappeCommand.etappenummer }"/>
		Datum: <c:out value="${etappeUitslagCommand.datum}"/>
		Start: <c:out value="${etappeUitslagCommand.startplaats}"/>
		Finish: <c:out value="${etappeUitslagCommand.finishplaats}"/>
		<form method="POST">
